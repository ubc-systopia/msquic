...
| `QUIC_PARAM_GLOBAL_DATAPATH_CONFIG`<br> 9         | QUIC_DATAPATH_CONFIG    | Both      | Globally configure the datapath used for QUIC. Must be set before opening registration.      |
